...
```bash
composer require dasher/tables:"^2.0"
...
module.exports = {
    content: [
        './resources/**/*.blade.php',
        './vendor/dasher/**/*.blade.php', // [tl! focus]
    ],
    theme: {
        extend: {
...
In `/resources/css/app.css`, import `dasher/forms` vendor CSS and [TailwindCSS](https://tailwindcss.com):

```css
@import '../../vendor/dasher/forms/dist/module.esm.css';
...
In `/resources/js/app.js`, import [Alpine.js](https://alpinejs.dev), the `dasher/forms` and `@alpinejs/focus` plugins, and register them:
```js
