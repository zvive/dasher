...
Column classes can be found in the `Dasher\Tables\Columns` namespace.
...
```php
use Dasher\Tables\Columns\TextColumn;
...
```php
use Dasher\Tables\Columns\BooleanColumn;
...
```php
use Dasher\Tables\Columns\ImageColumn;
...
```php
use Dasher\Tables\Columns\IconColumn;
...
```php
use Dasher\Tables\Columns\BadgeColumn;
...
```php
use Dasher\Tables\Columns\TagsColumn;
...
```php
use Dasher\Tables\Columns\ViewColumn;

ViewColumn::make('status')->view('dasher.tables.columns.status-switcher')
```
...
```php
use Dasher\Tables\Columns\Column;

class StatusSwitcher extends Column
{
    protected string $view = 'dasher.tables.columns.status-switcher';
}
```
