...
While Dasher doesn't provide a direct integration with [Laravel Scout](https://laravel.com/docs/scout), you may override methods to integrate it with your Livewire component.
...
With Dasher, this allows you to store your table's filters, sort, search and pagination state in the URL.
