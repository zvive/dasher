<div {{ $attributes->class(['dasher-tables-search-input']) }}>
  ...
  <div class="relative group">
    ...
    <input wire:model.debounce.1s="tableSearchQuery" id="tableSearchQueryInput"
      placeholder="{{ __('tables::table.fields.search_query.placeholder') }}" type="search"
