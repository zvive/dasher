...
<div
  {{ $attributes->merge($getExtraAttributes())->class([
          'px-4 py-3 flex dasher-tables-badge-column',
          match ($getAlignment()) {
              'left' => 'justify-start',
