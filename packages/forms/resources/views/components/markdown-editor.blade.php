    ...
    <div class="space-y-2">
                  ...
                  <x-forms::markdown-editor.toolbar-button
                    ...
                    <md-bold>
                      <svg @class([
                        ...
                        data-prefix="fas" data-icon="bold" role="img"
                  ...
                  <x-forms::markdown-editor.toolbar-button
                    ...
                    <md-code class="w-full h-full">
                      <svg @class([
                        ...
                        data-prefix="fas" data-icon="code" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        <path fill="currentColor"
          ...
          @if ($hasToolbarButton(['edit', 'preview']) && $isEnabled())
            <div class="flex items-center space-x-4 rtl:space-x-reverse">
              @if ($hasToolbarButton('edit'))
                <button x-on:click.prevent="tab = 'edit'"
      ...
      <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
        <file-attachment directory>
          <textarea {!! $isAutofocused() ? 'autofocus' : null !!} id="{{ $getId() }}" {!! ($placeholder = $getPlaceholder()) ? "placeholder=\"{$placeholder}\"" : null !!}
            {!! $isRequired() ? 'required' : null !!} x-model="state" dusk="dasher.forms.{{ $getStatePath() }}"
            x-on:keyup.enter="checkForAutoInsertion" x-on:file-attachment-accepted.window="
        ...
        <div x-ref="overlay" x-html="overlay" style="min-height: 150px;"
          @class([
