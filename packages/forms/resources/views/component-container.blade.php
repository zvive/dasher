<div @class([
    'grid gap-6 dasher-forms-component-container',
  ...
  @foreach ($getComponents() as $formComponent)
    <div @class([
        ...
        ($classes = $formComponent->getColumnSpan('default')) =>
            is_string($classes) && $classes !== 'full',
        ...
        ($classes = $formComponent->getColumnSpan('sm')) =>
            is_string($classes) && $classes !== 'full',
        ...
        ($classes = $formComponent->getColumnSpan('md')) =>
            is_string($classes) && $classes !== 'full',
        ...
        ($classes = $formComponent->getColumnSpan('lg')) =>
            is_string($classes) && $classes !== 'full',
        ...
        ($classes = $formComponent->getColumnSpan('xl')) =>
            is_string($classes) && $classes !== 'full',
        ...
        ($classes = $formComponent->getColumnSpan('2xl')) =>
            is_string($classes) && $classes !== 'full',
    ])>
      {{ $formComponent }}
    </div>
