...
Placeholder::make('Documentation')
    ->content(new HtmlString('<a href="https://dasherphp.com/docs">dasherphp.com</a>'))
```
...
View::make('dasher.forms.components.wizard')
```
...
{
    protected string $view = 'dasher.forms.components.wizard';
