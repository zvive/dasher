...
class Settings extends Page
{
    ...
    protected static string $view = 'dasher-settings::pages.settings-page';
    ...
    protected function getFormActions() : array
    {
        return [
            ButtonAction::make('save')
                ->label(\__('dasher-settings::pages/settings-page.form.actions.save.label'))
                ->submit('save'),
        ];
    }
    ...
    {
        return \__('dasher-settings::pages/settings-page.messages.saved');
    }
