...
class CreateRecord extends Page implements HasFormActions
{
    ...
    protected static string $view           = 'dasher::resources.pages.create-record';
    ...
    {
        return static::$breadcrumb ?? \__('dasher::resources/pages/create-record.breadcrumb');
    }

    protected function getCancelFormAction() : Action
    {
        return ButtonAction::make('cancel')
            ->label(\__('dasher::resources/pages/create-record.form.actions.cancel.label'))
    ...
    protected function getCreateAndCreateAnotherFormAction() : Action
    {
        return ButtonAction::make('createAnother')
            ->label(\__('dasher::resources/pages/create-record.form.actions.create_and_create_another.label'))
    ...
    {
        return \__('dasher::resources/pages/create-record.messages.created');
    }

    protected function getCreateFormAction() : Action
    {
        return ButtonAction::make('create')
            ->label(\__('dasher::resources/pages/create-record.form.actions.create.label'))
            ->submit('create');
    }
    ...
    protected function getTitle() : string
    {
        ...
        return \__('dasher::resources/pages/create-record.title', [
