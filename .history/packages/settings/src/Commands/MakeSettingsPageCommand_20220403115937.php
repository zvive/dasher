...
class MakeSettingsPageCommand extends Command
{
    ...
    protected $description = 'Creates a Dasher settings page class.';

    protected $signature = 'make:dasher-settings-page {name?} {settingsClass?}';
    ...
    protected function copyStubToApp(string $stub, string $targetPath, array $replacements = []): void
    {
        ...
        if (! $this->fileExists($stubPath = base_path("stubs/dasher/{$stub}.stub"))) {
