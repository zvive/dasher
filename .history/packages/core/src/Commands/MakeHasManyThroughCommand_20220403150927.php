...
class MakeHasManyThroughCommand extends Command
{
    ...
    protected $description = 'Creates a Dasher HasManyThrough relation manager class for a resource.';
    protected $signature   = 'z:dash-has-many-through {resource?} {relationship?} {recordTitleAttribute?} {--F|force}';
    ...
    public function handle() : int
    {
        ...
        $this->copyStubToApp('HasManyThrough', $path, [
