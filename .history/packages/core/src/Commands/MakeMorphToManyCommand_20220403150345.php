...
class MakeMorphToManyCommand extends Command
{
    ...
    protected $description = 'Creates a Dasher MorphToMany relation manager class for a resource.';
    protected $signature   = 'z:dash-morph-to-many {resource?} {relationship?} {recordTitleAttribute?} {--F|force}';
    ...
    public function handle() : int
    {
        ...
        $this->copyStubToApp('MorphToMany', $path, [
