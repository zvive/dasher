...
namespace Dasher\Resources\RelationManagers\Concerns;
...
trait CanCreateRecords
{
    ...
    {
        return __('dasher::resources/relation-managers/create.action.messages.created');
    }
    ...
    protected function getCreateAction(): Tables\Actions\ButtonAction
    {
        return Tables\Actions\ButtonAction::make('create')
            ->label(__('dasher::resources/relation-managers/create.action.label'))
            ->form($this->getCreateFormSchema())
            ->mountUsing(fn () => $this->fillCreateForm())
            ->modalActions($this->getCreateActionModalActions())
            ->modalHeading(__('dasher::resources/relation-managers/create.action.modal.heading', ['label' => static::getRecordLabel()]))
    ...
    protected function getCreateActionCreateModalAction(): Tables\Actions\Modal\Actions\Action
    {
        return ButtonAction::make('create')
            ->label(__('dasher::resources/relation-managers/create.action.modal.actions.create.label'))
    ...
    protected function getCreateActionCreateAndCreateAnotherModalAction(): Tables\Actions\Modal\Actions\Action
    {
        return ButtonAction::make('createAndCreateAnother')
            ->label(__('dasher::resources/relation-managers/create.action.modal.actions.create_and_create_another.label'))
