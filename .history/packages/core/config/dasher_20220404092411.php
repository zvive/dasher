...
return [
    ...
    'dashboards'          => [
        'admin' => [
            ...
            */
            ...
            'namespace' => 'App\\Dashboards\\Admin', // namespace for stubs
            'root_path' => 'app/Dashboards/Admin', // location to generate files.
            'view_path' => 'resources/views/admin',
            'route'     => 'admin', // route
            'pages'     => [
    ...
    */
        ...
        'default_avatar_provider' => \Dasher\Avatar\UiAvatarsProvider::class,
