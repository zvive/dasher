...
<th {{ $attributes->merge($extraAttributes)->class(['p-0 dasher-tables-header-cell']) }}>
  <button @if ($sortable) wire:click="sortTable('{{ $name }}')" @endif
    type="button" @class([
      ...
      <span @class([
        ...
        @else
          <x-heroicon-s-chevron-down
            :class="\Illuminate\Support\Arr::toCssClasses(['w-3 h-3', 'opacity-25' => ! $isSortColumn])" />
        @endif
