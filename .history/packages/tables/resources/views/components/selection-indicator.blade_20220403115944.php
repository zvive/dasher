@props(['allRecordsCount', 'colspan', 'selectedRecordsCount'])

<tr x-cloak {{ $attributes->class(['bg-primary-500/10 dasher-tables-selection-indicator']) }}>
  <td class="px-4 py-2 whitespace-nowrap text-sm" colspan="{{ $colspan }}">
    <div>
      <span x-show="isLoading">
        <svg class="inline-block animate-spin w-4 h-4 mr-3 text-primary-600"
