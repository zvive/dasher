<x-dynamic-component :component="$getFieldWrapperView()" :id="$getId()" :label="$getLabel()"
  ...
  <div x-data="richEditorFormComponent({
    ...
    x-on:trix-attachment-add="
        ...
        "
    {{ $attributes->merge($getExtraAttributes())->class(['space-y-2 dasher-forms-rich-editor-component']) }}
    ...
    @unless($isDisabled())
      ...
      <trix-toolbar id="trix-toolbar-{{ $getId() }}">
        <div
          ...
          <div class="flex items-stretch space-x-4 rtl:space-x-reverse focus:outline-none">
            @if ($hasToolbarButton(['bold', 'italic', 'strike', 'link']))
              <div data-trix-button-group="text-tools"
                ...
                @if ($hasToolbarButton('bold'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="bold" data-trix-key="b"
                    ...
                    <svg @class([
                      ...
                      data-prefix="fas" data-icon="bold" role="img" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 384 512">
                ...
                @if ($hasToolbarButton('italic'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="italic" data-trix-key="i"
                ...
                @if ($hasToolbarButton('strike'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="strike"
                ...
                @if ($hasToolbarButton('link'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="href"
                    data-trix-action="link" data-trix-key="k"
            ...
            @if ($hasToolbarButton(['h1', 'h2', 'h3']))
              <div data-trix-button-group="heading-tools"
                ...
                @if ($hasToolbarButton('h1'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="heading1"
                ...
                @if ($hasToolbarButton('h2'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="heading"
                ...
                @if ($hasToolbarButton('h3'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="subHeading"
            ...
            @if ($hasToolbarButton(['blockquote', 'codeBlock', 'bulletList', 'orderedList']))
              <div data-trix-button-group="block-tools"
                ...
                @if ($hasToolbarButton('blockquote'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="quote"
                ...
                @if ($hasToolbarButton('codeBlock'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="code"
                ...
                @if ($hasToolbarButton('bulletList'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="bullet"
                ...
                @if ($hasToolbarButton('orderedList'))
                  <x-forms::rich-editor.toolbar-button data-trix-attribute="number"
            ...
            @if ($hasToolbarButton('attachFiles'))
              <div data-trix-button-group="file-tools"
                class="flex items-stretch space-x-1 rtl:space-x-reverse">
                <x-forms::rich-editor.toolbar-button data-trix-action="attachFiles"
                  ...
                  <svg @class([
                    ...
                    data-prefix="fas" data-icon="image" role="img" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                    <path fill="currentColor"
          ...
          @if ($hasToolbarButton(['undo', 'redo']))
            <div data-trix-button-group="history-tools"
              class="flex items-center space-x-1 rtl:space-x-reverse">
              @if ($hasToolbarButton('undo'))
                <x-forms::rich-editor.toolbar-button data-trix-action="undo" data-trix-key="z"
              ...
              @if ($hasToolbarButton('redo'))
                <x-forms::rich-editor.toolbar-button data-trix-action="redo" data-trix-key="shift+z"
                  ...
                  <svg @class([
                    ...
                    data-prefix="fas" data-icon="rotate-right" role="img"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor"
          ...
          <div data-trix-dialog="href" data-trix-dialog-attribute="href"
            ...
            <div class="trix-dialog__link-fields">
              <input name="href"
                ...
                data-trix-input disabled type="url" class="trix-input trix-input--dialog">

              <div class="trix-button-group">
                <input value="{{ __('forms::components.rich_editor.dialogs.link.buttons.link') }}"
      ...
      <trix-editor wire:ignore {!! $isAutofocused() ? 'autofocus' : null !!} id="{{ $getId() }}"
        input="trix-value-{{ $getId() }}" placeholder="{{ $getPlaceholder() }}"
        toolbar="trix-toolbar-{{ $getId() }}" x-ref="trix"
        dusk="dasher.forms.{{ $getStatePath() }}" @class([
