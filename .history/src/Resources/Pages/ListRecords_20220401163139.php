...
class ListRecords extends Page implements Tables\Contracts\HasTable
{
    ...
    protected static string $view = 'dasher::resources.pages.list-records';
    ...
    {
        return static::$breadcrumb ?? __('dasher::resources/pages/list-records.breadcrumb');
    }
    ...
    protected function getViewAction(): Tables\Actions\Action
    {
        ...
        return config('dasher.layout.tables.actions.type')::make('view')
            ->label(__('dasher::resources/pages/list-records.table.actions.view.label'))
    ...
    protected function getEditAction(): Tables\Actions\Action
    {
        ...
        return config('dasher.layout.tables.actions.type')::make('edit')
            ->label(__('dasher::resources/pages/list-records.table.actions.edit.label'))
    ...
    protected function getDeleteBulkAction(): Tables\Actions\BulkAction
    {
        return Tables\Actions\BulkAction::make('delete')
            ->label(__('dasher::resources/pages/list-records.table.bulk_actions.delete.label'))
    ...
    {
        return __('dasher::resources/pages/list-records.table.bulk_actions.delete.messages.deleted');
    }
    ...
    protected function getCreateAction(): Action
    {
        ...
        return ButtonAction::make('create')
            ->label(__('dasher::resources/pages/list-records.actions.create.label', ['label' => $label]))
