...
namespace Dasher\Resources\Pages\ListRecords\Concerns;

use Dasher\Pages\Actions;
use Illuminate\Support\Str;
use Dasher\Pages\Actions\Action;
use Illuminate\Database\Eloquent\Model;
use Dasher\Resources\Pages\Concerns\UsesResourceForm;
...
trait CanCreateRecords
{
    ...
    protected function getCreateActionCancelModalAction() : Actions\ModalButtonAction
    {
        return Actions\ModalButtonAction::make('cancel')
            ->label(\__('tables::table.actions.modal.buttons.cancel.label'))
            ->cancel()
            ->color('secondary');
    }

    protected function getCreateActionCreateAndCreateAnotherModalAction() : Actions\ModalButtonAction
    {
        return Actions\ModalButtonAction::make('createAndCreateAnother')
    ...
    protected function getCreateActionCreateModalAction() : Actions\ModalButtonAction
    {
        return Actions\ModalButtonAction::make('create')
